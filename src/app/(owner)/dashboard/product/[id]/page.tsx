        ...
        <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: '1200px', mx: 'auto' }}>
            ...
            >
                ...
                {product.image && product.image.length > 0 ? (
                    <Carousel autoPlay={false} navButtonsAlwaysVisible indicators={product.image.length > 1} animation="slide">
                        {product.image.map((img, idx) => (
                            <motion.img
                                key={img.productImageId}
                                src={img.imagePath}
                                alt={`${product.name} - ${idx + 1}`}
                                style={{ width: '100%', maxHeight: 400, objectFit: 'contain', borderRadius: 12, marginBottom: 16 }}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Collapse in={openVariants[v.variantId]}>
                                            <Box mt={2}>
                                                <motion.div
                                                    style={{ position: 'relative', width: '100%', paddingTop: '66.66%', borderRadius: 8, overflow: 'hidden' }}
